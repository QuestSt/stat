...
--  ** ***************************************************************
--  **
--  **  Name:        STAT-6042 Add ability to reassign tasks with  “Tasks-Edit own tasks” privilege.
--  **
--  **  Description: STAT6.3 HotFix-O changes 
...
SET LINESIZE 999
SPOOL [SPOOLPT]/Stat6042ORA.LOG


SET SERVEROUTPUT ON SIZE 1000000
DECLARE
   l_script     VARCHAR2 (500 CHAR)   := 'STAT-6042 Add ability to reassign tasks with  “Tasks-Edit own tasks” privilege.';
...
DECLARE l_count integer;
    BEGIN
        ...
        IF  l_count > 0 THEN
           BEGIN 
                Update STAT.SYSTEM_RIGHTS set DESCR_LONG = 'Users with this right will be able to assign the task to other active users in the service domain.'
...
SET SERVEROUTPUT ON SIZE 1000000
DECLARE
   l_script     VARCHAR2 (500 CHAR)   := 'STAT-6042 Add ability to reassign tasks with  “Tasks-Edit own tasks” privilege.-OracleServer.sql Completed';
   l_username   VARCHAR2 (30 CHAR);
   l_schemaname VARCHAR2 (30 CHAR);
   l_machine    VARCHAR2 (64 CHAR);
   l_osuser     VARCHAR2 (30 CHAR);
...
COMMIT;
PROMPT ***
 SELECT '* End of Script STAT-6042 Add ability to reassign tasks with  “Tasks-Edit own tasks” privilege.-OracleServer for '||COMPANY_NAME FROM STAT.SYSTEM_TBL;
PROMPT *** ****************

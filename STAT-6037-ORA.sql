...
--  ** ***************************************************************
--  **
--  **  Name:        STAT-6037 Tasks – Edit Assign Task to User Assigned To User List is not correct
--  **
--  **  Description: STAT6.3 HotFix-N changes 
...
--  **
--  **  Script Summary:
--  **  a. Connect to the appropriate STAT Repo DATABASE.
--  **  b. Update text into STAT.SYSTEM_RIGHTS
...
SET LINESIZE 999
SPOOL [SPOOLPT]/Stat6037ORA.LOG


SET SERVEROUTPUT ON SIZE 1000000
DECLARE
   l_script     VARCHAR2 (500 CHAR)   := 'STAT-6037 Tasks – Edit Assign Task to User Assigned To User List is not correct-OracleServer.sql Started';
...
DECLARE l_count integer;
    BEGIN
        SELECT 1 INTO l_count FROM STAT.SYSTEM_RIGHTS WHERE RIGHT_CD = 'TSK-ESDM';
        IF  l_count > 0 THEN
           BEGIN 
                Update STAT.SYSTEM_RIGHTS set DESCR_LONG = 'Users with this right will be able to assign the tasks to other users who have the same right and have access to this service domain.'
				where RIGHT_CD = 'TSK-ESDM'; 
                COMMIT;
            EXCEPTION
               WHEN OTHERS
               THEN
        ...
        END;
/	  
PROMPT * Update in STAT Table SYSTEM_RIGHTS Completed



SET SERVEROUTPUT ON SIZE 1000000
DECLARE
   l_script     VARCHAR2 (500 CHAR)   := 'STAT-6037 Tasks – Edit Assign Task to User Assigned To User List is not correct-OracleServer.sql Completed';
   l_username   VARCHAR2 (30 CHAR);
   l_schemaname VARCHAR2 (30 CHAR);
   l_machine    VARCHAR2 (64 CHAR);
   l_osuser     VARCHAR2 (30 CHAR);
...
COMMIT;
PROMPT ***
 SELECT '* End of Script STAT-6037 Tasks – Edit Assign Task to User Assigned To User List is not correct-OracleServer for '||COMPANY_NAME FROM STAT.SYSTEM_TBL;
PROMPT *** ****************
